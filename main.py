...
st.markdown("""<div style = "text-align:centre; padding: 2rem 0;">
            <h1 style="color: #ff4b4b; font-size: 3rem; margin-bottom:0.5rem">🏥 MediChat Pro</h1>
            <p style = "font-size : 1.2rem; color: #666;margin-bottom: 2rem;">Your Medical Document Assistant</p>
...
if prompt := st.chat_input("Ask about your medical documents......."):
    ...
    if st.session_state.vector_store and st.session_state.chat_model:
        with st.chat_message("assistant"):
            with st.spinner("🔍 Searching documents..."):
                ...
                Based on the following medical documents procide accurate and helpful answers.
                If the information is not available clearly state that.
                When you are giving an answer make sure to try to take help of llms and give full diagnosis of the problem.
